...
const PHOTOS: Photo[] = [
  ...
  { src: "/images/JuanCarlos.jpeg", alt: "Juan Carlos, barbero profesional", size: "tall" },
  { src: "/images/JuanCarlos1.jpeg", alt: "Juan Carlos trabajando", size: "square" },
  { src: "/images/page.jpeg", alt: "Página de la barbería", size: "wide" },
  { src: "/images/Visagismo.jpeg", alt: "Servicio de visagismo", size: "tall" },
  { src: "/images/Producto1.jpeg", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto1.jpg", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto2.jpeg", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto3.jpg", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto4.webp", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto5.jpg", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto6.jpg", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/producto7.png", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/producto8.png", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/producto9.png", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto10.png", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto11.png", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto12.png", alt: "Producto para el cuidado del cabello", size: "square" },
  { src: "/images/Producto13.png", alt: "Producto para el cuidado del cabello", size: "square" },
];
