...
export default function TeamSpotlight({
  kicker = "GROOMING & WELLNESS",
  title = "LA FAMILIA",
  blurb = "A HAND-PICKED GROUP OF TALENTED, ENTHUSIASTIC, AND FRIENDLY PROFESSIONALS MAKE SURE EACH GUEST LEAVES OUR SALON FEELING PERFECTLY GROOMED AND REFRESHED.",
  name,
